...
<div class="row">
	...
	<div class="col-xs-24 col-sm-18 pw-content">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-body">
						...
						<label style="width: 30%"> <input type="checkbox" class="po" id="excode" checked> Số công văn đến/đi
						</label>
			...
			<div style="margin-bottom: 10px; margin-top: 10px;">
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td>
							<select class="form-control" style="width: 200px" name="from_signer" id="from_signer_{LISSIS.id}"
					...
					<tr>
						<td colspan="2" class="text-center"><input class="btn btn-primary" type="submit" value="Search"
								name="timkiem">
						</td>
					</tr>
					...
					<tr>
						...
						<td class="text-center">
							...
							<em class="fa fa-edit fa-lg">&nbsp;</em><a
								href="/index.php?nv=dispatch&op=add_document&inter=1&id={ROW.id}">Sửa</a>
							&nbsp;&nbsp; -
							<!-- END: v1 -->
							<!-- BEGIN: v2 -->
							<em class="fa fa-trash-o fa-lg">&nbsp;</em><a href="javascript:void(0);" onclick="del({ROW.id});">Xóa</a>
							<!-- END: v2 -->
						</td>
					</tr>
					<!-- END: row -->
		...
		<script type="text/javascript">
			...
			var nv_is_del_confirm = ['Bạn thực sự muốn xóa? Nếu đồng ý, tất cả dữ liệu l… xóa. Bạn sẽ không thể phục hồi lại chúng sau này', 'Lệnh Xóa đã được thực hiện', 'Vì một lý do nào đó lệnh Xóa đã không được thực hiện']
			...
			function del(id) {
				if (confirm('Bạn thực sự muốn xóa? Nếu đồng ý, tất cả dữ liệu liên quan sẽ bị xóa. Bạn sẽ không thể phục hồi lại chúng sau này')) {
					vhttp.checkelse('', {
						action: 'del',
						id: id
					}).then(resp => {
